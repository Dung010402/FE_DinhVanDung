            ...
            <div className="">
                ...
                <nav className="mt-4">
                    <ul className="flex justify-center">
                        <li>
                            <Link className="p-2 hover:bg-gray-200" href="#" onClick={prePage}>
                                Prev
                            </Link>
                        </li>
                        {numbers.map((number, index) => (
                            <li key={index}>
                                <Link className="p-2 px-4 hover:bg-gray-200" onClick={() => changeCPage(number)}>
                                    {number}
                                </Link>
                            </li>
                        ))}
                        <li>
                            <Link className="p-2 hover:bg-gray-200" href="#" onClick={nextPage}>
                                Next
                            </Link>
                        </li>
                    </ul>
